...
import styles from './AttemptDetailPage.module.css'
...
function AttemptDetailPage() {
  ...
  // `attempt.evaluation` is exactly what was stored at submission
  // time — this page never calls evaluateDesign. Same architecture
  // rule as EvaluationResultPage.
  const { evaluation } = attempt

  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <span className={styles.eyebrow}>Past attempt · {formatDate(attempt.createdAt)}</span>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>Submitted design</h2>
        <SubmittedDesign
